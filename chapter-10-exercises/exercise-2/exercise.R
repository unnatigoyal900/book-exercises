...
salaries[salaries$adjustments == max(salaries$adjustments), "adjustments"]-salaries[salaries$adjustments == min(salaries$adjustments), "adjustments"]
...
getwd()
salary_data <- read.csv('/Users/unnatigoyal/Desktop/INFO201/a2-core-skills-unnatigoyal900')
